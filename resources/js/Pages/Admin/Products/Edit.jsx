...
export default function ProductsEdit({ productId }) {
    ...
    return (
        <AdminLayout title={products.form.edit_product_title}>
            <PageHeader breadcrumb={[{ label: admin.manage_products_title, href: route('admin.products.index') }, { label: common.edit }]} title={products.form.edit_product_title} />

            <div className="rounded-md border border-border bg-muted/40 px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">{products.fields.vendor}</p>
