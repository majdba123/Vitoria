@php
    ...
    $links = [
        ...
        ['group' => __('admin.management'), 'route' => 'admin.categories.index', 'label' => __('admin.categories'), 'icon' => 'fa-solid fa-layer-group'],
        ['group' => __('admin.management'), 'route' => 'admin.subcategories.index', 'label' => 'Subcategories', 'icon' => 'fa-regular fa-folder-open'],
...
<aside id="admin-sidebar" class="dashboard-sidebar fixed inset-y-0 left-0 z-50 flex w-72 -translate-x-full flex-col lg:translate-x-0">
