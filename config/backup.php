...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Private uploads: vendor compliance documents, commercial
                    // registers (see app/Models/VendorDocument.php).
                    storage_path('app/private'),
                    // Public uploads: product photos and other publicly-served
                    // media that isn't in git (storage/app/public/.gitignore
                    // excludes everything under it).
                    storage_path('app/public'),
                    // Needed to reconstruct the environment on a fresh host;
                    // the backup archive itself is never publicly reachable
                    // (see the 'backups' disk in config/filesystems.php).
                    base_path('.env'),
                ],
    ...
    'monitor_backups' => [
        [
            ...
            'disks' => ['backups'],
            'health_checks' => [
                // Backups run daily; allow a 1-day grace window before a
                // missed/late run is reported unhealthy.
