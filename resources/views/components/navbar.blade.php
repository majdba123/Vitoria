...
<header class="site-header">
    <div class="site-header-main">
        ...
        <div class="flex shrink-0 items-center gap-1">
            ...
            <x-language-switcher />
            {{-- Dark Mode Toggle --}}
            <button id="theme-toggle" type="button" class="nav-action-btn relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-transparent text-gray-500 dark:text-gray-400" aria-label="{{ __('nav.toggle_theme_aria') }}" title="{{ __('nav.toggle_theme_aria') }}">
...
@php
    $navStrings = [
        ...
        'browse_subcategories' => __('nav.browse_subcategories'),
        'all_category_products' => __('nav.all_category_products'),
