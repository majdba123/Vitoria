    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // app.jsx/ssr.jsx resolve pages via ./Pages/**/*.jsx (capital P) —
            // match that here, since Windows' case-insensitive filesystem
            // hides a mismatch with the package's lowercase default.
