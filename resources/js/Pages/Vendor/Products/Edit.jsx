...
export default function VendorProductsEdit({ productId }) {
    ...
    useEffect(() => {
        Promise.all([
            window.axios.get('/api/vendor/allowed-categories', { silent: true }),
            window.axios.get(`/api/vendor/products/${productId}`, { silent: true }),
    ...
    const savePhotos = () => {
        ...
        window.axios.post(`/api/vendor/products/${productId}/photos/update`, formData, { headers: { 'Content-Type': 'multipart/form-data' }, silent: true })
            .then((res) => {
