<section class="page-shell pb-5 pt-2 sm:pb-6 sm:pt-3">
    <div class="storefront-hero">
        <div class="storefront-hero-copy">
            ...
            <h1 class="mt-5 max-w-xl text-3xl font-bold leading-tight tracking-tight sm:text-4xl lg:text-5xl" style="color: var(--color-text); font-family: var(--font-display);">
        ...
        <div class="storefront-hero-media">
            <img src="{{ asset('images/hero-agriculture.webp') }}" alt="" loading="eager">
        </div>
    </div>
</section>
