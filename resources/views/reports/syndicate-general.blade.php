...
<table class="kpis"><tr><td><p class="lbl">{{ $l['vendors'] }}</p><strong>{{ $data['kpis']['vendors'] }}</strong></td><td><p class="lbl">{{ $l['active'] }}</p><strong>{{ $data['kpis']['active_vendors'] }}</strong></td><td><p class="lbl">{{ $l['orders'] }}</p><strong>{{ $data['kpis']['completed_orders'] }}</strong></td></tr><tr><td><p class="lbl">{{ $l['units'] }}</p><strong>{{ $data['kpis']['units_sold'] }}</strong></td><td><p class="lbl">{{ $l['sales'] }}</p><strong>{{ $money($data['kpis']['gross_sales']) }}</strong></td><td><p class="lbl">{{ $l['refunds'] }}</p><strong class="negative">{{ $money($data['kpis']['refunds']) }}</strong></td></tr></table>
