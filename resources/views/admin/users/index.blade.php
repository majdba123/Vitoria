...
<div id="delete-modal" class="mobile-dialog">
    <div class="mobile-dialog-card">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h3 id="delete-modal-title" class="text-base font-semibold text-gray-900 dark:text-white">Delete User</h3>
                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">This will permanently delete this user account and all their tokens.</p>
            </div>
        </div>
...
function initAdminUsersPage() {
    ...
    function renderUsers(users) {
            ...
            <tr>
                ...
                <td class="text-end">
                    <div class="row-actions-menu">
                        <button type="button" class="row-actions-trigger" aria-label="Actions: ${escapeHtml(user.name || '')}">
                        ...
                        <div class="row-actions-panel dropdown-panel">
                            <a href="/admin/users/${user.id}">View Profile</a>
                            <a href="/admin/orders?user_id=${user.id}">View Order History</a>
                            <a href="/admin/users/${user.id}/edit">Edit</a>
                            <button type="button" class="is-danger" onclick="openDeleteModal(${user.id})">Delete</button>
                        </div>
                    </div>
                </td>
            </tr>
        ...
        usersTbody.querySelectorAll('.row-actions-menu').forEach((menu) => {
