      ...
      >
        <SheetContent
          ...
          <SheetHeader className="sr-only">
            <SheetTitle>{common.mobile_sidebar}</SheetTitle>
            <SheetDescription>{common.mobile_sidebar_description}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}>
      <PanelLeftIcon />
      <span className="sr-only">{common.toggle_sidebar}</span>
    </Button>
  );
}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // child (a long topbar title, a data table) would push the whole shell
        // past the viewport and scroll the page sideways instead of itself.
