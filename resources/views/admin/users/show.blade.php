...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    function renderUser(user) {
        const roleLabel = { 0: 'User', 1: 'Admin', 2: 'Vendor', 3: 'Syndicate', 4: 'Employee' };
        const roleBadge = { 0: 'bg-blue-100 text-blue-700', 1: 'bg-purple-100 text-purple-700', 2: 'bg-brand-100 text-brand-700', 3: 'bg-amber-100 text-amber-700', 4: 'bg-cyan-100 text-cyan-700' };
