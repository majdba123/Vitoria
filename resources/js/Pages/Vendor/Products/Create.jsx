...
export default function VendorProductsCreate() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await submit('post', '/api/vendor/products', formData, { isMultipart: 'raw' });
    ...
    return (
        <VendorLayout title={vendor.add_product}>
            <PageHeader breadcrumb={[{ label: vendor.products, href: route('vendor.products.index') }, { label: vendor.add_product }]} title={vendor.add_product} />
                ...
                <Card className="border-border/80 shadow-none">
                    <CardContent className="space-y-5 p-5 sm:p-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <SelectField id="category_id" label={products.fields.category} required value={categoryId} onValueChange={setCategoryId} placeholder={products.form.select_category_placeholder} options={categories.map((c) => ({ value: c.id, label: c.name }))} error={errors.category_id} />
